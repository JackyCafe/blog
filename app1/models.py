...
class Activity(models.Model):
    ...
    group = models.ManyToManyField(Group,on_delete=models.CASCADE,related_name='activity')
...
class Card(models.Model):
    ...
    group = models.ManyToManyField(Group, on_delete=models.CASCADE, related_name='card')
